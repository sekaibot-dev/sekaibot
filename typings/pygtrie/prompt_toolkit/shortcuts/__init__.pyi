...
def print_formatted_text(*values: Any, sep: str = ..., end: str = ..., file: TextIO | None = ..., flush: bool = ..., style: BaseStyle | None = ..., output: Output | None = ..., color_depth: ColorDepth | None = ..., style_transformation: StyleTransformation | None = ..., include_default_pygments_style: bool = ...) -> None:
    """
    ::
...
def print_container(container: AnyContainer, file: TextIO | None = ..., style: BaseStyle | None = ..., include_default_pygments_style: bool = ...) -> None:
    """
