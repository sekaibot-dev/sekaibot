...
from typing import Any, AnyStr, ClassVar, Final, Literal as L, NoReturn, ParamSpec, SupportsIndex, TypeAlias, TypeVar, overload, type_check_only
...
_ComparisonFunc: TypeAlias = Callable[[NDArray[Any], NDArray[Any]], (bool | np.bool | number[Any] | NDArray[np.bool | number[Any] | object_])]
...
def assert_approx_equal(actual: _ConvertibleToFloat, desired: _ConvertibleToFloat, significant: int = ..., err_msg: object = ..., verbose: bool = ...) -> None:
    ...
...
@overload
def tempdir(suffix: AnyStr | None = ..., prefix: AnyStr | None = ..., dir: GenericPath[AnyStr] | None = ...) -> _GeneratorContextManager[AnyStr]:
    ...
...
@overload
def temppath(suffix: AnyStr | None = ..., prefix: AnyStr | None = ..., dir: GenericPath[AnyStr] | None = ..., text: bool = ...) -> _GeneratorContextManager[AnyStr]:
    ...
...
def run_threaded(func: Callable[[], None], iters: int, pass_count: bool = ...) -> None:
    ...
