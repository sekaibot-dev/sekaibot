...
@overload
def fftfreq(n: int | integer[Any], d: _ArrayLikeFloat_co = ..., device: None | L["cpu"] = ...) -> NDArray[floating[Any]]:
    ...

@overload
def fftfreq(n: int | integer[Any], d: _ArrayLikeComplex_co = ..., device: None | L["cpu"] = ...) -> NDArray[complexfloating[Any, Any]]:
    ...

@overload
def rfftfreq(n: int | integer[Any], d: _ArrayLikeFloat_co = ..., device: None | L["cpu"] = ...) -> NDArray[floating[Any]]:
    ...

@overload
def rfftfreq(n: int | integer[Any], d: _ArrayLikeComplex_co = ..., device: None | L["cpu"] = ...) -> NDArray[complexfloating[Any, Any]]:
    ...
