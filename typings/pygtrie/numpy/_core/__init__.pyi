...
@overload
def index(a: U_co, sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.int_]:
    ...

@overload
def index(a: S_co, sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.int_]:
    ...
...
@overload
def rindex(a: U_co, sub: U_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.int_]:
    ...

@overload
def rindex(a: S_co, sub: S_co, start: i_co = ..., end: None | i_co = ...) -> NDArray[np.int_]:
    ...
...
def decode(a: S_co, encoding: None | str = ..., errors: None | str = ...) -> NDArray[np.str_]:
    ...

def encode(a: U_co | T_co, encoding: None | str = ..., errors: None | str = ...) -> NDArray[np.bytes_]:
    ...
...
@overload
def translate(a: U_co, table: str, deletechars: None | str = ...) -> NDArray[np.str_]:
    ...

@overload
def translate(a: S_co, table: str, deletechars: None | str = ...) -> NDArray[np.bytes_]:
    ...

@overload
def translate(a: _StringDTypeSupportsArray, table: str, deletechars: None | str = ...) -> _StringDTypeArray:
    ...

@overload
def translate(a: T_co, table: str, deletechars: None | str = ...) -> _StringDTypeOrUnicodeArray:
    ...
