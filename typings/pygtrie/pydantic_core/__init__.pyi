...
class SchemaValidator:
    ...
    def validate_python(self, input: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ...) -> Any:
        """
    ...
    def isinstance_python(self, input: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ...) -> bool:
        """
    ...
    def validate_json(self, input: str | bytes | bytearray, *, strict: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ...) -> Any:
        """
    ...
    def validate_strings(self, input: _StringInput, *, strict: bool | None = ..., context: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ...) -> Any:
        """
    ...
    def validate_assignment(self, obj: Any, field_name: str, field_value: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ...) -> dict[str, Any] | tuple[dict[str, Any], dict[str, Any] | None, set[str]]:
        """
...
class SchemaSerializer:
    ...
    def to_python(self, value: Any, *, mode: str | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool | Literal['none', 'warn', 'error'] = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> Any:
        """
    ...
    def to_json(self, value: Any, *, indent: int | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool | Literal['none', 'warn', 'error'] = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> bytes:
        """
