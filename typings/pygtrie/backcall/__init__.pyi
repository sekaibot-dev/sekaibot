...
class Parameter:
    ...
    * kind : str
    ...
    VAR_KEYWORD = ...
    empty = _empty
    def __init__(self, name, kind, default=..., annotation=..., _partial_kwarg=...) -> None:
        ...
    ...
    def replace(self, name=..., kind=..., annotation=..., default=..., _partial_kwarg=...): # -> Self:
...
class Signature:
    ...
    * bind_partial(*args, **kwargs) -> BoundArguments
    ...
    empty = _empty
    def __init__(self, parameters=..., return_annotation=..., __validate_parameters__=...) -> None:
    ...
    @property
    def parameters(self): # -> MappingProxyType[Any, Any] | OrderedDict[Any, Any]:
        ...
    ...
    def replace(self, parameters=..., return_annotation=...): # -> Self:
