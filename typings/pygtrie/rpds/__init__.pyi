...
class HashTrieMap(Mapping[_KT_co, _VT_co]):
    def __init__(self, value: Mapping[_KT_co, _VT_co] | Iterable[tuple[_KT_co, _VT_co]] = ..., **kwds: Mapping[_KT_co, _VT_co]) -> None:
        ...
    ...
    def update(self, *args: Mapping[_KU_co, _VU_co] | Iterable[tuple[_KU_co, _VU_co]]) -> HashTrieMap[_KT_co | _KU_co, _VT_co | _VU_co]:
        ...
    
    @classmethod
    def convert(cls, value: Mapping[_KT_co, _VT_co] | Iterable[tuple[_KT_co, _VT_co]]) -> HashTrieMap[_KT_co, _VT_co]:
        ...
    
    @classmethod
    def fromkeys(cls, keys: Iterable[_KT_co], value: _VT_co = ...) -> HashTrieMap[_KT_co, _VT_co]:
        ...
